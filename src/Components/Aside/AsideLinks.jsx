...
function AsideLinks() {
  ...
  return (
    <div className='aside__boxes d-flex align-items-center'>
      ...
      <div className='aside__box twitter'><a className='aside-messangers' href={`https://twitter.com/${typeof(data) !== 'undefined' ? data.twitter : "/"}`} target="_blank"><FaTwitter className='twitter' /></a></div>
      <div className='aside__box instagram'><a className='aside-messangers' href="#" target="_blank"><BsInstagram className='instagram' /></a></div>
      <div className='aside__box youtube'><a className='aside-messangers' href="#" target="_blank"><BsYoutube className='youtube ' /></a></div>
      <div className='aside__box telegram'><a className='aside-messangers' href={`https://telegram.me/share/url?url=${typeof(data) !== 'undefined' ? data.telegram : "/"}`} target="_blank"><FaTelegramPlane className='telegram' /></a></div>
    </div>
  )
}
