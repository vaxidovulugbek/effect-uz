    ...
    <div className='d-flex justify-content-between'>
     {
       newsLocRes.map((item,i) => {
        if(+location1 === item.id) {
         ...
         <h2 className='info__title'>{i18n.language === "uz" ? item.title_uz : i18n.language === "oz" ? item.title_oz : item.title_oz}</h2>
         ...
         <p className='info__text'>{parse(`${i18n.language === "uz" ? item.description_uz : i18n.language === "oz" ? item.description_oz : item.description_oz}`)}</p>
            ...
            <NavLink to={`/main/muxbir/${item.id}`}><span className='info__n-title'>{item.user}</span></NavLink>
             <div className='info__n-main d-flex align-items-center'>
               ...
               <div className='info__n-btns d-flex align-items-center'>
                 <button><p>Baholangan:</p> <span>1203</span></button>
                 <button><p>Reyting:</p> <span>3.5</span></button>
               </div>
             </div>
           </div>
           <div className='info__bottom d-flex align-items-center'>
             <div className='d-flex align-items-center'>
               <p className='info__bottom-text'>Maqolani ulashing</p>
         ...
         <form className='izoh__form'>
           ...
           <div className='izoh__form-bottom'>
               ...
               <button onClick={() => addCommentClicked}>JO’NATISH</button>
           </div>
         </form>
         </div>
