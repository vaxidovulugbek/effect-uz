      ...
      <div className='audios__info'>
        {
          audiosarr.map((item,i)=> {
            ...
            <div className='audios__info-c'>
              <h3 className='audios__info-title'>Playing card effect and box shadow effect. Audio wave chiqib turadi play bo’lganda. Default holatda 1-si play bo’ladi. text color ham o’zgaradi</h3>
              <div className='d-flex '>
