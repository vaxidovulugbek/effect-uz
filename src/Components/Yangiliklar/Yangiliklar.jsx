    ...
    <div className='d-flex'>
        ...
        </div>
      {
          cardArray.map((item,i) => {
            return <div className='yangiliklar__c'>
          <div className='yangiliklar__content d-flex'>
            ...
            <img className='yangiliklar__img' src="https://motor.ru/thumb/1500x0/filters:quality(75):no_upscale()/imgs/2022/01/29/16/5202862/d3eec90797e2fc10f4aed051be461cea1e72f473.jpg" alt="" />
            <div className='yangiliklar__info'>
            <p className='yangiliklar__info-text'>Card hover bo’lganda title color o’zgarishi va card box-shadow ham o’zgarmoqda</p>
